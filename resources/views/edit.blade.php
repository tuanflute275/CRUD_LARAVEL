...
<div class="form-group">
  ...
  <input type="text"
    class="form-control" name="name"  placeholder="Enter name..." value="{{old('name') ?? $userDetail->name}}">
    @error('name')
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="email" name="email" class="form-control" id="inpEmail" placeholder="Enter email..." \
